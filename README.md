...
Это форк билда Goob Station под названием Samosbor.

## Links

[Дискорд сервер Самосбора](https://discord.gg/jHXEqjuSdc) | [Дискорд сервер по разработке Самосбора](https://discord.gg/gKzKaxYngF)

## Contributing

Мы будем рады принять вклад от любого желающего. Присоединяйтесь к [Разработке Самосбора в Дискорде] (https://discord.gg/gKzKaxYngF), если хотите помочь. Также не бойтесь обращаться за помощью!
Хотя соблюдение правил [Space Station 14 contribution guidelines](https://docs.spacestation14.com/en/general-development/codebase-info/pull-request-guidelines.html) не является обязательным для Самосбора, мы рекомендуем ознакомиться с ними для получения рекомендаций.

## Building

1. Клонируйте этот репозиторий.
2. Запускайте `RUN_THIS.py` чтобы инициализировать подмодули и загрузить движок.
3. Скомпилируйте билд.
